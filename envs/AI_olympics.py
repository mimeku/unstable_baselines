...
from unstable_baselines.envs.olympics_engine.scenario import Running_competition, table_hockey, football, wrestling
import sys
...
class AI_Olympics:
    def __init__(self, random_selection, minimap):
        ...
        # 和json当中吻合，running环境没有competition当中的包装
        # 而其他环境已经自带了competition的信息
